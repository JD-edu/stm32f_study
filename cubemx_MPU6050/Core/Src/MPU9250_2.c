...
void MPU9250_Read_Accel(I2C_HandleTypeDef *I2Cx, MPU9250_t *DataStruct)
{
    ...
    HAL_I2C_Mem_Read(I2Cx, MPU9250_ADDR, ACCEL_XOUT_H, 1, Rec_Data, 6, i2c_timeout);
...
void MPU9250_Read_Gyro(I2C_HandleTypeDef *I2Cx, MPU9250_t *DataStruct)
{
    ...
    HAL_I2C_Mem_Read(I2Cx, MPU9250_ADDR, GYRO_XOUT_H, 1, Rec_Data, 6, i2c_timeout);
