...
// Keep this location for below header files. IF not, header files can be erased
// during CubMX code generation.
#include "i2c.h"
// After CubeMX code generation, please delete MX_I2C1_Init(). Because i2C.h already has it.
#include "MPU9250_2.h"
#include "mpu9250.h"
#include <stdio.h>
